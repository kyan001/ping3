...
def command_line_exec(assigned_args: list = None):
    """
    ...
    """
    import argparse
    parser = argparse.ArgumentParser(prog="ping3", description="A pure python3 version of ICMP ping implementation using raw socket.")
    ...
    for addr in args.dest_addr:
        verbose_ping(addr, count=args.count, ttl=args.ttl, timeout=args.timeout, size=args.size)
